    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#0D1117', color: '#fff' }}>
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 py-32 overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ zIndex: 0 }}>
          <img src="/images/background.png" alt="" className="w-full h-full object-cover" style={{ opacity: 0.07 }} />
      ...
      <section className="px-6 py-24" style={{ background: '#161B22', borderTop: '1px solid #21262D' }}>
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px mt-12" style={{ background: '#21262D' }}>
            ...
            <AnimateIn direction="up" delay={0} className="text-center py-10 px-4" style={{ background: '#0D1117' }}>
            ...
            <AnimateIn direction="up" delay={100} className="text-center py-10 px-4" style={{ background: '#0D1117' }}>
              <p className="font-black text-4xl mb-1" style={{ color: '#10B981' }}>
            ...
            <AnimateIn direction="up" delay={200} className="text-center py-10 px-4" style={{ background: '#0D1117' }}>
              <p className="font-black text-4xl mb-1" style={{ color: '#10B981' }}>
            ...
            <AnimateIn direction="up" delay={300} className="text-center py-10 px-4" style={{ background: '#0D1117' }}>
      ...
      {/* ── Hero image + copy ──────────────────────────────── */}
      <section className="px-6 py-24" style={{ background: '#0D1117', borderTop: '1px solid #21262D' }}>
        <div className="max-w-5xl mx-auto flex flex-col lg:flex-row items-center gap-16">

          <AnimateIn direction="left" className="flex-1">
          ...
          <AnimateIn direction="right" delay={150} className="flex-1">
            <img src="/images/hero_arancela.png" alt="Arancela" className="w-full h-auto object-contain" />
          </AnimateIn>
      ...
      {/* ── Procesos ───────────────────────────────────────── */}
      <section className="px-6 py-20" style={{ background: '#161B22', borderTop: '1px solid #21262D' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px" style={{ background: '#21262D' }}>
            {[
              ...
              <AnimateIn key={p.title} direction="up" delay={p.delay}>
                <div className="flex items-start gap-4 p-8" style={{ background: '#0D1117' }}>
      ...
      <section className="px-6 py-24 text-center" style={{ background: '#0D1117', borderTop: '1px solid #21262D' }}>
        <AnimateIn direction="up" className="max-w-2xl mx-auto flex flex-col items-center">
          <img src="/images/logo_arancela.png" alt="Arancela" className="h-10 w-auto object-contain mb-10" />
